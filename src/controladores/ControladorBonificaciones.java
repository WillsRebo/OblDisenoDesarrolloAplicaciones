...
public void inicialiar(){
    ...
    public void actualizar(Object evento, Observable origen) {
        if(evento.equals(Fachada.eventos.cambiosListaBonificaciones)){ 
    ...
    public void asignarBonificacion(Propietario propietario, String nombrePuesto, String tipoBonificacion) {
            try{        
                ...
                Asignacion a = new Asignacion(bonif,propietario,puesto);

            propietario.agregarAsignacion(a);
            vista.mostrarInfoProp(propietario, propietario.getAsignaciones());
            //propietario.avisar(eventos.cambiosListaBonificaciones);

        //el propietario debe avisar directo AG
            //Fachada.getInstancia().avisar(Fachada.eventos.cambiosListaBonificaciones);
            }catch(PeajeException ex){
                vista.error(ex.getMessage());
            }
    }
