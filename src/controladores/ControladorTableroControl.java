...
public class ControladorTableroControl implements Observador{
    ...
    public ControladorTableroControl(VistaTableroControl vista, Propietario propietario) {
        this.vista = vista;
    ...
    public void actualizar(Object evento, Observable origen) {
      mostrarCantidadDatos();
      if(evento.equals(Propietario.eventos.cambioListaRecargas)){mostrarRecargas();}
      if(evento.equals(Propietario.eventos.cambiosListaBonificaciones)){mostrarBonificaciones();}
      if(evento.equals(Propietario.eventos.cambioListaNotificaciones)){mostrarNotificaciones();}
      if(evento.equals(Propietario.eventos.cambioListaVehiculo)){mostrarVehiculo();}
      if(evento.equals(Propietario.eventos.cambioListaTransitos)){mostrarTransito();}
      if(evento.equals(Fachada.eventos.cambiosListaRecarga)){mostrarRecargas(); mostrarDatosProp();}
      if(evento.equals(Fachada.eventos.cambiosListaTransito)){mostrarTransito();mostrarVehiculo(); }
    ...
    private void mostrarDatosProp() {
        vista.mostrarDatosProp(propietario);
    }
    ...
    private void mostrarCantidadDatos() {
        ...
        vista.mostrarCantidadDatos(cantVehiculos, cantNotificaciones, cantAsignaciones, cannTransitos, cantRecargas);
    }
